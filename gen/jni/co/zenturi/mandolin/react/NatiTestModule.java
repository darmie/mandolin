...
@ReactModule(name = "NatiTestModule")
public final class NatiTestModule extends ReactContextBaseJavaModule {

	private final CppProxy mModule;

	public NatiTestModule(ReactApplicationContext reactContext){
		super(reactContext);
