...
#if java 
import co.zenturi.mandolin.xnative.react.Job.IJob;
...
@:keep
@:nativeGen
@:native('co.zenturi.mandolin.xnative.JobDispatcher')
...
@:include('co/zenturi/mandolin/xnative/react/IJavascriptDispatcher.h')
