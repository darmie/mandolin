...
import co.zenturi.mandolin.xnative.react.ReactBridge.IReactBridge;
...
@:keep
@:nativeGen
@:native('co.zenturi.mandolin.xnative.MandolinReact')
class MandolinReact extends IMandolinReact {
    ...
    override public static function createReactBridge(context:#if java ReactApplicationContext #else Dynamic #end):IReactBridge {
        return new co.zenturi.mandolin.xnative.react.ReactBridge(context);
    }
