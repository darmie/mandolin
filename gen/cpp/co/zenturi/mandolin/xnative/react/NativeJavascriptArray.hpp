...
private:
	...
	const jmethodID method_pushArray { ::mandolin::jniGetMethodID(clazz.get(), "pushArray", "(Lco/zenturi/mandolin/xnative/react/react/JavascriptArray;)V") };
	const jmethodID method_pushMap { ::mandolin::jniGetMethodID(clazz.get(), "pushMap", "(Lco/zenturi/mandolin/xnative/react/react/JavascriptMap;)V") };
	const jmethodID method_pushObject { ::mandolin::jniGetMethodID(clazz.get(), "pushObject", "(Lco/zenturi/mandolin/xnative/react/react/JavascriptObject;)V") };
	const jmethodID method_append { ::mandolin::jniGetMethodID(clazz.get(), "append", "(Lco/zenturi/mandolin/xnative/react/react/JavascriptArray;)V") };
};
