...
namespace mandolin_generated {
	...
	CJNIEXPORT object JNICALL Java_co_zenturi_mandolin_react_TestModule_create(JNIEnv* jniEnv, jobject /*this*/, ::mandolin_generated::NativeReactBridge::JniType j_bridge) {
		try {
